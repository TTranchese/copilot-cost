...
Three statusline styles are available out of the box:
...
By default, the statusline renders a zeroed placeholder (e.g. `$0.0000 · 0 in / 0 out`) as soon as a chat opens, before any usage data arrives. Set `COPILOT_COST_HIDE_ZERO=1` to suppress it and show an empty statusline until the first response.
